...
public class TelaRanking_Facil extends JFrame {
    ...
    public TelaRanking_Facil() {
        ...
        for(int i = 0; i < lista_ranking.size(); ++i) {
            if (((Ranking)lista_ranking.get(i)).getDificuldade().getNome().equals("Fácil")) {
        ...
        this.bVoltar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                TelaRanking_Facil.this.dispose();
        ...
        this.bVoltar.addMouseListener(new MouseListener() {
            public void mouseExited(MouseEvent e) {
                TelaRanking_Facil.this.bVoltar.setBackground(new Color(255, 215, 0));
            }

            public void mouseClicked(MouseEvent e) {
                TelaRanking_Facil.this.bVoltar.setBackground(Color.YELLOW);
            }
