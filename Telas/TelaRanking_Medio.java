...
public class TelaRanking_Medio extends JFrame {
    ...
    public TelaRanking_Medio() {
        ...
        for(int i = 0; i < lista_ranking.size(); ++i) {
            if (((Ranking)lista_ranking.get(i)).getDificuldade().getNome().equals("Médio")) {
        ...
        this.bVoltar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                TelaRanking_Medio.this.dispose();
        ...
        this.bVoltar.addMouseListener(new MouseListener() {
            public void mouseExited(MouseEvent e) {
                TelaRanking_Medio.this.bVoltar.setBackground(new Color(255, 215, 0));
            }

            public void mouseClicked(MouseEvent e) {
                TelaRanking_Medio.this.bVoltar.setBackground(Color.YELLOW);
            }
